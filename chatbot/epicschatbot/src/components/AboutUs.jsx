...
<section className="text-center mb-20">
  <div className="grid grid-cols-1 md:grid-cols-2 gap-10 w-11/12 md:w-10/12 mx-auto">
    ...
    >
      <h2 className="text-4xl font-serif font-bold text-[#3572EF] mb-4">Our Vision</h2>
    ...
    <motion.div
      ...
      className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-transform"
    >
      <h2 className="text-4xl font-serif font-bold text-[#3572EF] mb-4">Our Mission</h2>
      ...
      {/* Core Values */}
      <section className="text-center mb-20">
        <h2 className="text-5xl font-bold text-[#050C9C] mb-8">Our Core Values</h2>
          ...
          {[
            ...
            >
              <div className="flex flex-col items-center text-center">
                {value.icon}
                <h3 className="text-2xl font-semibold text-[#3572EF] mt-2">{value.title}</h3>
      ...
      <section className="text-center mb-20">
        <h2 className="text-5xl font-bold text-[#050C9C] mb-8">Behind the Innovation</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-11/12 md:w-10/12 mx-auto">
          {[
            { icon: <FaWater className="text-[#3ABEF9] text-5xl mb-4" />, title: "The Problem", text: "Impurities and contaminants in water pose serious health risks. Our mission is to provide safe, clean, and refreshing water." },
            { icon: <FaShieldAlt className="text-[#3ABEF9] text-5xl mb-4" />, title: "The Solution", text: "Advanced filtration technology that eliminates contaminants while preserving essential minerals for health." },
            { icon: <FaMicrochip className="text-[#3ABEF9] text-5xl mb-4" />, title: "Smart Monitoring", text: "Our purifiers come with smart sensors to monitor water quality and ensure optimal performance." },
            { icon: <FaRecycle className="text-[#3ABEF9] text-5xl mb-4" />, title: "Eco-Friendly Design", text: "We prioritize sustainability with energy-efficient systems and minimal plastic usage." }
          ].map((feature, index) => (
            <motion.div 
              key={index}
              whileHover={{ scale: 1.05 }}
